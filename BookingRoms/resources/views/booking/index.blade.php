...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Daftar Booking Ruangan') }}</div>
                                        ...
                                        <table id="add-row" class="display table table-striped table-hover dataTable" role="grid" aria-describedby="add-row_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" id="sorting_nama" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">Tanggal Booking</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php $no = 1 ?>
                                                ...
                                                <tr role="row" class="{{$no%2?'odd':'even'}}">
                                                    ...
                                                    <td>{{\Carbon\Carbon::parse($item->booking_time)->format('d/m/Y')}}</td>
                                                    <td><a href="{{url('booking/view?bookingId='.$item->id)}}" class="btn btn-warning"> View </a> </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
